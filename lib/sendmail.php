...
/**************************** Test ***********************************/
$mail = new MySendMail();
//$mail->setServer("smtp.gmail.com", "XXX@gmail.com", "XXX", 465, true); //到服务器的SSL连接
//$mail->setServer("smtp.gmail.com", "XXX@gmail.com", "XXX"); //如果不需要到服务器的SSL连接，这样设置服务器
$mail->setFrom("XXX@gmail.com");
$mail->setReceiver("XXX@gmail.com");
$mail->setReceiver("XXX@gmail.com");
$mail->setCc("XXX@gmail.com");
$mail->setCc("XXX@gmail.com");

//$mail->setCc("XXX@gmail.com");
//$mail->setBcc("XXX@gmail.com");
//$mail->addAttachment("sms.zip");
//$mail->addAttachment("test.php");
//$mail->addAttachment("01.png");
$html = implode('', file ($argv[2]));
$mail->setMail("$argv[1]", "$html");
$mail->sendMail();
